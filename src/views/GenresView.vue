      ...
      <table class="table table-striped mb-5 mx-auto">
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-2 px-5">
              <div
                class="d-flex justify-content-end align-items-end flex-column flex-md-row gap-3 gap-md-5"
              >
                <button
                  class="btn btn-yellow d-flex flex-column flex-md-row align-items-center gap-2 px-3 rounded-2 btn-sm action-btn flex-shrink-0"
                  @click="editGenre(genre)"
                >
                  <font-awesome-icon
                    icon="fa-solid fa-pen-to-square responsive-icon"
                  />
                  <span>Editar</span>
                </button>
                <button
                  ...
                  class="btn btn-danger d-flex flex-column flex-md-row align-items-center gap-2 action-btn btn-sm flex-shrink-0"
        ...
        <div class="modal-body">
          {{
            toDeleteMovies.length > 0
              ? ` Este genero aparece en ${toDeleteMovies.length} peliculas, al
                    borrar
                    este
                    genero, este desaparecera de estas mismas, ¿desea continuar?`
              : "¿Desea borrar este genero?"
          }}
